...
> **仅供学习交流使用 · For Educational Purposes Only**
>
> 本项目仅供个人学习、技术研究与交流用途，**不内置任何视频内容或下载源**，所有播放数据均来自第三方公开网络资源。请勿用于任何商业用途。下载或克隆本项目后，请于 24 小时内删除。
>
> 若本项目涉及的任何第三方资源侵犯了您的合法权益，请通过 issue 或邮件联系作者，将在确认后立即处理删除。
...
- **仅供学习交流**：本项目为个人学习与技术研究用途，不提供任何视频内容、下载源或服务器，所有数据均来自第三方公开网络资源。严禁用于商业用途。请于下载/克隆后 24 小时内删除。
